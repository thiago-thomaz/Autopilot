...
export class RssPublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'RSS';
  private mockFallback = new MockPublicationAdapter('RSS');
