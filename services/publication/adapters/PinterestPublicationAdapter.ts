...
export class PinterestPublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'PINTEREST';
  private mockFallback = new MockPublicationAdapter('PINTEREST');
