...
export class XPublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'X';
  private mockFallback = new MockPublicationAdapter('X');
