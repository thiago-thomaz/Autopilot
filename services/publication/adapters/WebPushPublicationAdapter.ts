...
export class WebPushPublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'WEB_PUSH';
  private mockFallback = new MockPublicationAdapter('WEB_PUSH');
