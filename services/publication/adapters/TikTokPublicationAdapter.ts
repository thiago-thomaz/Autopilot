...
export class TikTokPublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'TIKTOK';
  private mockFallback = new MockPublicationAdapter('TIKTOK');
