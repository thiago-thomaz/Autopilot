...
export class YouTubePublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'YOUTUBE';
  private mockFallback = new MockPublicationAdapter('YOUTUBE');
