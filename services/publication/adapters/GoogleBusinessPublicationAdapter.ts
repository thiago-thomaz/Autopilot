...
export class GoogleBusinessPublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'GOOGLE_BUSINESS_PROFILE';
  private mockFallback = new MockPublicationAdapter('GOOGLE_BUSINESS_PROFILE');
