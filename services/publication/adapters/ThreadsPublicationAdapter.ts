...
export class ThreadsPublicationAdapter extends BasePublicationAdapter {
  public readonly channel: OmnichannelChannel = 'THREADS';
  private mockFallback = new MockPublicationAdapter('THREADS');
