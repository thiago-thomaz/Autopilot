    ...
    const getCuratedProducts = (q: string) => {
      ...
      const allDepartmentCatalog = [
        // --- ALIMENTOS E BEBIDAS ---
        {
          ...
          price: 24.90,
          previousPrice: 29.90,
          url: `https://www.amazon.com.br/s?k=%22Café+Orfeu+Gourmet+Intenso+250g%22&tag=${tag}`,
        ...
        },
        {
          ...
          price: 39.90,
          previousPrice: 48.00,
          url: `https://www.amazon.com.br/s?k=%22Azeite+Andorinha+Extra+Virgem+500ml%22&tag=${tag}`,
        ...
        },
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22Whey+100+Pure+Max+Titanium+900g%22&tag=${tag}`,
        ...
        },
        {
          ...
          price: 54.90,
          previousPrice: 69.90,
          url: `https://www.amazon.com.br/s?k=%22Casillero+del+Diablo+Cabernet+Sauvignon+750ml%22&tag=${tag}`,
        ...
        },
        {
          ...
          price: 21.90,
          previousPrice: 26.90,
          url: `https://www.amazon.com.br/s?k=%22Lindt+Excellence+70+Cacau+100g%22&tag=${tag}`,
        ...
        // --- CASA E COZINHA ---
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22Air+Fryer+Mondial+AFN-40-BI%22&tag=${tag}`,
        ...
        },
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22Electrolux+PCC20%22&tag=${tag}`,
        ...
        },
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22Eufy+RoboVac+G20%22&tag=${tag}`,
        ...
        // --- BELEZA E CUIDADOS PESSOAIS ---
        {
          ...
          price: 79.90,
          previousPrice: 99.90,
          url: `https://www.amazon.com.br/s?k=%22Anthelios+Airlicium+FPS+60%22&tag=${tag}`,
        ...
        },
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22Vichy+Liftactiv+Vitamin+C%22&tag=${tag}`,
        ...
        // --- BEBÊS E CRIANÇAS ---
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22Pampers+Premium+Care+M+80%22&tag=${tag}`,
        ...
        // --- PET SHOP ---
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22Premier+Cães+Adultos+Raças+Médias+Frango+15kg%22&tag=${tag}`,
        ...
        // --- LIVROS E PAPELARIA ---
        {
          ...
          price: 44.90,
          previousPrice: 64.90,
          url: `https://www.amazon.com.br/s?k=%22Hábitos+Atômicos+James+Clear%22&tag=${tag}`,
        ...
        },
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22LG+UltraGear+24+IPS+144Hz%22&tag=${tag}`,
        ...
        },
        {
          ...
          url: `https://www.amazon.com.br/s?k=%22SSD+Kingston+NV2+1TB%22&tag=${tag}`,
